      ...
      <section class="container mt-5">
        <div class="row mt-5">
          <div class="text-center col-6">
            <h2 class="text-primary mt-5">MENU DE ADMINISTRACION</h2>
          </div>
      ...
      <section class="container">
            ...
            <!-- si se quiere una ventana nueva hay que poner la instruccion target="_blank" dentro de a -->
              ...
              <div class="col-3 mt-3 ">
				...
				<div class="col-3 mt-3 ">
                <a href="Formulario_inserta_perfiles.php"> <img src="librerias/img/iconos/perfiles.png" class="rounded" style="width: 75px; height:75px; margin-left:auto; margin-right:auto; display: block;">
                <H4 class="text-center text-primary">REGISTRO</H4></a>
              </div>     			  
